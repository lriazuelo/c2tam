...
bool GeneratePlyCb(c2tam_srvs::SaveMap::Request  &req,
		           c2tam_srvs::SaveMap::Response &res );

bool GetOctomapCb(c2tam_srvs::GetOctomap::Request  &req,
		           c2tam_srvs::GetOctomap::Response &res );
...
//ROS, added by Luis 19/07/2011
  ...
  ros::ServiceServer generate_ply_ ;
  ros::ServiceServer get_octomap_;
