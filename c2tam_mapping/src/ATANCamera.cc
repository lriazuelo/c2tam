...
{
//  fprintf(stderr,"Camera.Parameters %f %f %f %f %f\n",(*mgvvCameraParams)[0],(*mgvvCameraParams)[1],(*mgvvCameraParams)[2],(*mgvvCameraParams)[3],(*mgvvCameraParams)[4]);
...
{
  //cerr << "Camera.Parameters=[0.8366    0.6763    0.7101    0.3505    0.5236]\n";
  //cerr << "Desproyeccion: " << mvImageSize[0] << "  " << mvImageSize[1] << endl;
      /* << "               " << (*mgvvCameraParams)[0]
       << "    " << (*mgvvCameraParams)[1] << "   " << (*mgvvCameraParams)[2]
       << "    " << (*mgvvCameraParams)[3] << "   " << (*mgvvCameraParams)[4] << endl;*/
  mvLastIm = v2Im;
...
void ATANCamera::print()
{
  //cerr << "Camera.Parameters=[0.8366    0.6763    0.7101    0.3505    0.5236]\n";
  cerr << "Focal:  " <<   mvFocal << endl
       << "Centro: " << mvCenter << endl;
  cerr << "Tamano: " << mvImageSize[0] << "  " << mvImageSize[1] << endl
       << "               " << (*mgvvCameraParams)[0]
       << "    " << (*mgvvCameraParams)[1] << "   " << (*mgvvCameraParams)[2]
       << "    " << (*mgvvCameraParams)[3] << "   " << (*mgvvCameraParams)[4] << endl;
}
