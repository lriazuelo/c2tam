...
//#include <c2tam_msgs/PeopleList.h>
//#include <c2tam_msgs/BlobPeople.h>
...
class Visualizer
{
    ...
    ros::Subscriber people_remove_sub;
 ...
 //   void peopleRemoveCb(const c2tam_msgs::PeopleList::ConstPtr& msg);
